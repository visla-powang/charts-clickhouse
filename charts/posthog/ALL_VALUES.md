...
![Version: 18.2.3](https://img.shields.io/badge/Version-18.2.3-informational?style=flat-square) ![AppVersion: 1.34.2](https://img.shields.io/badge/AppVersion-1.34.2-informational?style=flat-square)
...
| image.tag | string | `nil` | PostHog image tag to use (example: `release-1.34.2`). |
| image.default | string | `":release-1.34.2"` | PostHog default image. Do not overwrite, use `image.sha` or `image.tag` instead. |
